...
public class SinchService extends Service {
	...
	private static final String APP_KEY     = Resources.getSystem().getString(R.string.APP_KEY);
	private static final String APP_SECRET  = Resources.getSystem().getString(R.string.APP_SECRET);
	private static final String ENVIRONMENT = Resources.getSystem().getString(R.string.ENVIRONMENT);
